...
//components
import { NavbarResponsive } from "../../component";
  ...
  return (
    <div className="nav">
      <div className="nav__left">
        ...
        >
          <g fillRule="evenodd" className="nav__logo">
            <path
      ...
      <input type="checkbox" className="nav__input" id="nav__input" />
      <div className="nav__right">
        <div className="nav__item"> Premium </div>
        <div className="nav__item"> Support </div>
        <div className="nav__item">Download</div>
        <label for="nav__input" className="nav__label">
          <div className="nav__item nav__response" onClick={handleNavbar}></div>
        </label>
        <div className="nav__item"> Sign up </div>
        <div className="nav__item"> Log in </div>
      </div>
      <div className="nav__responsive hidden">
        <NavbarResponsive />
      </div>
    </div>
  );
